...
model_parameter = "adaboost_lr0p1_lossSquare_nest1000_minsamplesplit4_maxdepth10_sqrt_random"
...
ada_tree_estimator = DecisionTreeRegressor(min_samples_split=4, max_depth=10, max_features='sqrt', splitter='random')
#adaboost regressor
