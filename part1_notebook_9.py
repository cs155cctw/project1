...
model_parameter = "adaboost_lr0p01_lossSquare_nest1000_minsamplesplit2_maxdepth10_sqrt_random_skipdatacolumn012"
...
ada_tree_estimator = DecisionTreeRegressor(min_samples_split=2, max_depth=10, max_features='sqrt', splitter='random')
#adaboost regressor
